				...
				<div className="container container--cart">
					<div className="cart">
						<div className="cart__top">
							...
							<div className="cart__clear" onClick={handleCart}>
								<svg
									width={20}
									height={20}
									viewBox="0 0 20 20"
								...
								return (
									<div key={index} className="cart__item">
										...
										<div className="cart__item-info">
											<h3>{cartItem.name}</h3>
											<p>
												{cartItem.category} - {cartItem.activePower}
											</p>
										</div>
										<div className="cart__item-count">
											<div
												onClick={() => dispatch(decrementProduct(cartItem))}
											...
											<b>{cartItem.count}</b>
											<div
												onClick={() => dispatch(addProduct(cartItem))}
			...
			<div className="content">
				<div className="container container--cart">
					<div className="cart cart--empty">
						...
						<p>
							Вероятней всего, вы еще не сделали заказ.
							<br />
